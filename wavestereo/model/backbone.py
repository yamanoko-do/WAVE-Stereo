...
from wavestereo.layers.basic_block_2d import BasicConv2d, BasicDeconv2d
...
class Backbone(nn.Module):
    def __init__(self, backbone='MobileNetv2', pretrained=False):
        super().__init__()
        ...
        self.bn1 = model.bn1
        self.act1 = getattr(model, 'act1', nn.ReLU6(inplace=True))  # timm >= 1.0 compat
